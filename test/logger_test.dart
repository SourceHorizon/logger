...
void main() {
  ...
  test('Logger.log', () {
    var logger = Logger(filters: [NeverFilter()], printer: callbackPrinter);
    logger.log(Level.debug, 'Some message');

    expect(printedMessage, null);

    logger = Logger(filters: [AlwaysFilter()], printer: callbackPrinter);
  ...
  test('Logger.t', () {
    var logger = Logger(filters: [AlwaysFilter()], printer: callbackPrinter);
    var stackTrace = StackTrace.current;
  ...
  test('Setting log level', () {
    ...
    expect(logger.level, initLevel);

    logger.level = Level.fatal;
    expect(logger.level, Level.fatal);
  });
